...
// who would you invite? Make a list that includes at least three people you’d like to invite to dinner. 
// Then use your list to print a message to each person, inviting them to dinner.
var not_presant = "Adil Shah";
var new_guest = "Azeem";
new_guest = Guest_list[1];
for (var i = 0; i < Guest_list.length; i++) {
    console.log("Dear sir" + new_guest[i] + "\nwe have invited to u for dinner party tonioght\nthanks");
}
console.log("we have really sorry ".concat(not_presant, " is not caming party tonight"));
//Q16 solved here
...
while (Guest_list.length > 2) {
    ...
    console.log("sorry sir. ".concat(remove_guest, "you are not invited for the dinner"));
}
for (var i = 0; i < Guest_list.length; i++) {
